-- bp_inventory (0RESMON "0DAY BP INVENTORY") bridge — CLIENT.
-- See server.lua for why this is an ox_inventory clone (bp provides
-- 'ox_inventory', so exports.ox_inventory:* resolves to bp's compat layer).
